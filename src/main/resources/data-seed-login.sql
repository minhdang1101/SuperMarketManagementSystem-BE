...
BEGIN
    ...
    SELECT 
        'admin',
        '$2a$10$4EI69xA12fh40ZeYtf2p9uIVw9EfLtDL9mQKSeZp0Gw7hUo0Sxria',  -- password: "password"
        N'Quản trị viên',
        'admin@smms.local',
        '0901234567',
...
-- Đồng bộ mật khẩu cho cả các tài khoản đã được tạo bởi seed cũ.
UPDATE [user]
SET password = '$2a$10$4EI69xA12fh40ZeYtf2p9uIVw9EfLtDL9mQKSeZp0Gw7hUo0Sxria',
    updated_at = GETDATE()
